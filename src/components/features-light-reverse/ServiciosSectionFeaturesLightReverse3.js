...
export default function ServiciosSectionFeaturesLightReverse3() {
    return (
        <React.Fragment>
            <>
      ...
      <div className="flex flex-wrap -m-8">
        ...
        <div className="w-full md:w-1/2 p-8">
          <div className="md:max-w-md">
            ...
            <h2 className="font-heading mb-4 text-4xl text-gray-900 font-black tracking-tight">Diseño y Desarrollo de Páginas Web</h2>
