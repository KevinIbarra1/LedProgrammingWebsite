...
export default function ServiciosSectionFeaturesLightReverse4() {
    return (
        <React.Fragment>
            <>
      ...
      <div className="flex flex-wrap -m-8">
        <div className="w-full md:w-1/2 p-8">
          <div className="md:max-w-md">
            ...
            <h2 className="font-heading mb-10 text-4xl text-gray-900 font-black tracking-tight">Optimizacion de busqueda</h2>
        ...
        <div className="w-full md:w-1/2 p-8"><img className="mx-auto md:mr-0 rounded-3xl" src="zanrly-assets/images/features/business.png" alt="" /></div>
      </div>
    </div>
  </div>
</section>
